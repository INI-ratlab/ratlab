...
class Setup( Freezeable ):
	...
	def toString(self):
		...
		s += str('world.dim').ljust(20)          + str(self.world.dim).translate(None,'[]')         +'\n'
		s += str('world.box_dim').ljust(20)      + str(self.world.box_dim).translate(None,'[]')     +'\n'
		...
		s += str('world.limits').ljust(20)       + str(self.world.limits).translate(None,'[]')      +'\n\n'
		# rat paramerters
		s += str('rat.color').ljust(20)    + str(self.rat.color)            +'\n'
		s += str('rat.fov').ljust(20)      + str(self.rat.fov).translate(None,'[]')  +'\n'
		...
		s += str('rat.bias').ljust(20)     + str(self.rat.bias).translate(None,'[]') +'\n'
